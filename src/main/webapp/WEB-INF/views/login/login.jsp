              ...
              <form>
                  <fieldset>
                      ...
                      <ul>
                        <li>
                        	<label>ID</label>
                            <input type="text" value="aircuvetest" class="" id="userId">
                        </li>
                        <li>
                        	<label>Password</label>
                            <span class="w100"><input type="text" id="password" onkeypress="if(event.keyCode==13) {btnClick(); return false;}" value="password" /></span>
                        </li>
                      </ul>
                      <div class="crbtnArea"><button type="button" class="crbtn medi navy" onclick="javascript:authentication()">Login</button></div>
                  </fieldset>
              </form>
              <ul class="clsInfo_links">
            	<li><a href="#;">Create new an account</a></li>
			...
			$.ajax({
				...
				success: function(result, request) {
					...
					if(res.success == "true") {
						...
						document.location.href = "/view/result";
